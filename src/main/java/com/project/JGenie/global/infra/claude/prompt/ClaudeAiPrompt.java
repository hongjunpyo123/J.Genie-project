...
public class ClaudeAiPrompt {
    public static String COVER_LETTER_PROMPT(ClaudeAiRequest claudeAiRequest) {
        return """
                ...
                8. '지원자 경력' 텍스트를 분석해서 작성자의 글쓰기 습관(실수, 어색함, 개인적 표현 포함)을 완벽히 파악하고, 자소서를 생성할때 이를 반영, 내용은 변경하지 말고 오직 문체와 표현만 바꿔서 같은 사람이 직접 쓴 것처럼 작성
                9. 자연스러운 실수(ex: 띄어쓰기 ", ' , . , ? , 의 사용 등)을 자연스럽게 반영하여 작성.
